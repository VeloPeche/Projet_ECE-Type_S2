...
int main() {
    ...
    //chargement des différents BITMAP
    ...
    while (1){
        ...
        while (1){
            ...
            if (mouse_b & 1){
                ...
                if (mx > SCREEN_W/2-100 && mx < SCREEN_W/2+100 & my > SCREEN_H/2-30  && my < SCREEN_H/2+60)
                {
        ...
        // choix entre les trois niveaux
        int niveau=demander_niveau(page,fond_menu);

        // patterns selon le niveaux
        static Spawn patternF1[66]={
            ...
            {34, 95},{35, 15},{35, 175},{36, 255},{38, 75},
            {38, 395},{38, 5},{39, 135},{40, 215},{40, 355},{42, 25},
            {42, 165},{44, 305},{44, 145},
            {50, 285},{47, 25},{53, 350},
        };
        ...
        static Spawn patternF2[] = {
            ...
            {16,0},{17,80},
              {18,30},{19,70},
                {29,0},{30,80},{31,130},{32,210},{33,290},{34,385},
                  {38,100},{38,210},
...
{30,0},{31,50},{32,130},{33,210},{34,290},{35,380},
   {36,380},{39,380},{39,250},{40,230},
{40,    90},{42,300},{42,80},{42,230}, {45,0},{43,159},{45,250},{43,350},
{44,5},{45,5},{44,165},
        ...
        static Spawn patternE3[] = {
            ...
            {10,160},{10,233   },{11,390},{11,310},{13,160},{13,253   },{13,335}
            ,{14,155},{15,213   },{16,390},{17,160},{18,243   },{18,385},{20,240   },{20,380},{21,200   },{21,390}
            ,{22,397},{23,392   },{24,234},{24,160},{24,0},{25,10},{26,5},{26,395},{26,230}
            ,{27,0},{28,88   },{29,178},{29,38},{30,250},{30,350},{31,388   },{31,178},{34,328   },{34,248}
            ,{35,0},{35,88   },{35,178},{36,160},{36,233   },{39,200},{39,280},{40,240},{40,160},{41,253},{41,100},
              {42,40},{42,180   },{44,156},{44,268},{46,8   },{46,230},{47,243   },{47,385},{48,390},{49,310},{50,290},{50,380}
            ,{   51,15},{53,250},{55,400},
        ...
        const int tir_tps     =500;
        time_t debut          =time(NULL);
        int vitE              =vitesse_ennemi_selon_niveau(niveau);
        int vitC              =vitesse_coeur_selon_niveau(niveau);
        int screenx           =0;
        time_t temps_debut_pause =0; //permetra de "gelé" tps pendant pause
        int en_pause =0;
        time_t tps_pause_total =0;

        //boucle du jeu
        while (!key[KEY_ESC]&& v.nb_vie > 0&& difftime(time(NULL), debut) < DUREE_NIVEAU)
        {
            int t =(int)(difftime(time(NULL),debut) - tps_pause_total);
            ...
            if (key[KEY_P] && !en_pause){
                ...
                tps_pause_total += (time(NULL) - temps_debut_pause);
                en_pause =0;
            }
            ...
            // 3) Tir du joueur
            if (key[KEY_SPACE] && clock() - dernier_tir >= tir_tps){ //appui espace=tir
