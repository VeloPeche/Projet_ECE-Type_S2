...
void afficher_barre_vie(BITMAP *buf, Vaisseau *v){
    ...
    if (v->nb_vie > 2)        couleur_vie = makecol(0, 255, 0);
    else if (v->nb_vie == 2)  couleur_vie = makecol(255, 255, 0);
    else                      couleur_vie = makecol(255,   0,   0);
...
int main(){
    ...
    // DÉBOUNCE : 500 ms de latence après entrée du pseudo
    clear_keybuf();
    rest(500);
